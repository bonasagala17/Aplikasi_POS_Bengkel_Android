...
public class Kelola_Data_SparepartAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kelola__data__sparepart);
        ...
        listenerSparepart = new SparepartAdapter.RecyclerViewSparepartClickListener() {
            ...
            public void onRowClick(View view, int position) {
                Intent intent = new Intent(Kelola_Data_SparepartAct.this, SparepartEditorAct.class);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Kelola_Data_SparepartAct.this, SparepartEditorAct.class));
            }
        });
    }
    ...
    public void getSparepart(){
        ...
        call.enqueue(new Callback<List<Sparepart>>() {
            ...
            public void onResponse(Call<List<Sparepart>> call, Response<List<Sparepart>> response) {
                ...
                sparepartAdapter = new SparepartAdapter(sparepartList, Kelola_Data_SparepartAct.this, listenerSparepart);
            ...
            public void onFailure(Call<List<Sparepart>> call, Throwable t) {
                Toast.makeText(Kelola_Data_SparepartAct.this, "rp :"+
